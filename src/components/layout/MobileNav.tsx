    ...
    >
      {NAV_ITEMS.map(item => {
        ...
        return (
          ...
          >
            <span className={`transition-all duration-250 ${active ? 'drop-shadow-[0_0_6px_rgba(167,139,250,0.7)] -translate-y-0.5' : ''}`}>
              {item.icon}
            </span>
